...
You can provide colors by name (not all r color names are recognised) or hexcode with the `color_name` argument. To set the color to red, you can use any of the following:
